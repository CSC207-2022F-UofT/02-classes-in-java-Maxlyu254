...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two strings as argument. The name of the newly constructed
     * object would be a concatenation of the two.
     *
     * @param name1 the first part of the name of the silly object.
     *
     * @param name2 the second part of the name of the silly object.
     */
    ...
    public static void main(String[] args) {
        ...
        int a1 = x.countStatic();
        int a2 = y.countStatic();
        int a3 = x.countStatic();
        int a4 = x.countStatic();
        int[] expected_values = {a1, a2, a3, a4};
